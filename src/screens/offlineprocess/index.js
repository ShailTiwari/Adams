      ...
      return (
        ...
        <Header>
         <Left>
          ...
          <Body>
            <Title>Offline New Process</Title>
          </Body>
          <Right />
        </Header>
         <Content padder>
          ...
          <View   style = {mystyles.container} >
            {
               ...
               <View style={mystyles.row_cell_timeplace}>
                 ...
                 <Button rounded success
                  ...
                  onPress={() =>this.props.navigation.navigate('editOfflineprocess', 
                      {docId:item.DocId,PlanID:item.PlanUniqueID,OperatorID:this.state.myoperatorid,PrID:item.PrID,
