...
import { Container, Header, Title, Content, Button, Item, Label, Input, Footer,FooterTab,Body,Left, Right,Icon,Form, Badge,ListItem,CheckBox} from "native-base";
...
class List extends Component 
{
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      SeqNo : props.navigation.state.params.SeqNo,
...
formBody = formBody.join("&");
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            {
               this.setState({ spinner:false });
               alert('problem while Start Activity');
            })
        .done(); 
      }
...
{
  this.setState({ spinner:false });
  alert("Operator should be same For this job  of All activity")
}
}
    ...
    else   if (myactivity_ActivityID=='00003')
     {
      ...
      if (myprocess_id=='Pr') 
      {
        //printingmodal
          ...
          var chkboxop =this.state.printingendop;
            ...
            console.log("Response:",responseData);
                 ...
                 if (ticketList.code =='200')
                   ...
                   this.setState({ spinner:false });                   
                    ...
                    { this.setState({ spinner:false });
                       alert('Activity End Fail');
                    }
            
         }).catch((error) => 
            {  this.setState({ spinner:false });
               alert('problem while End  Activity');
            })
        .done();
...
fetch(Constants.service_url+'Production/getOperator',{
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            {
                alert('problem while Get Operator data');
                this.setState({ spinner:false });
            })
        .done();   
  };
 ...
 .then((response) => response.json())
        .then((responseData) => {
            console.log("Response:",responseData);
                ...
                alert('problem while Check Status data');
            })
        .done();   
  };
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            this.setState({ spinner:false });
               ...
               this.setState({ spinner:false });
                alert('problem while Get Online Process data');
            })
        .done();   
  };
...
fetch(Constants.service_url+'Production/getMFault',
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            {
                this.setState({ spinner:false });
                alert('problem while Get Fault data');
            })
        .done();   
  };
      ...
      return (
        ...
        <Header>
         <Left>
          ...
          <Body>
            <Title>Edit Running Process</Title>
          </Body>
          <Right />
        </Header>
         <Content padder>
