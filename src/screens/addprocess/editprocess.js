 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            { 
               ...
               alert('problem while End Activity data');
            })
        .done();
...
fetch(Constants.service_url+'Production/getOperator',{
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            {
               this.setState({ spinner:false });
                alert('problem while adding Operator');
            })
        .done();   
  };
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            this.setState({ jobdata: ticketList.data });
                ...
                this.setState({ spinner:false });
                alert('problem while adding Job Data');
            })
        .done();   
  };
...
alert(this.state.process_id);
alert(this.state.MachineNo);*/
 ...
 .then((response) => response.json())
        .then((responseData) => {
            console.log("Response:",responseData);
                ...
                alert('problem while adding data fetch JTimeDetail ID');
            })
        .done();   
  };
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            this.setState({ spinner:false });
               ...
               this.setState({ spinner:false });
                alert('problem while adding Activity Running');
            })
        .done();   
  };
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            this.setState({ spinner:false });
               ...
               this.setState({ spinner:false });
                alert('problem while adding Online Process');
            })
        .done();   
  };
...
fetch(Constants.service_url+'Production/getMFault', {
 ...
 .then((response) => response.json())
        .then((responseData) => {
            ...
            {
                Alert('problem while adding Fault List');
            })
        .done();   
  };
